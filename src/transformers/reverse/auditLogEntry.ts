...
export function transformAuditLogEntryToDiscordAuditLogEntry(
  ...
  return {
        ...
        case "$remove":
          return {
            ...
            new_value: (
              ...
              id: val.id
                ? bot.transformers.reverse.snowflake(val.id)
                : undefined,
              name: val.name,
            })),
            old_value: (
        ...
        case "id":
          return {
            ...
            old_value: change.old
              ? bot.transformers.reverse.snowflake(change.old as bigint)
              : "",
            new_value: change.new
              ? bot.transformers.reverse.snowflake(change.new as bigint)
              : "",
          };
        case "name":
        case "description":
    ...
    user_id: payload.userId
      ? bot.transformers.reverse.snowflake(payload.userId)
      : null,
    target_id: payload.targetId
      ? bot.transformers.reverse.snowflake(payload.targetId)
      : null,
    ...
    options: payload.options
      ? {
          ...
          channel_id: payload.options.channelId
            ? bot.transformers.reverse.snowflake(payload.options.channelId)
            : "",
          message_id: payload.options.messageId
            ? bot.transformers.reverse.snowflake(payload.options.messageId)
            : "",
          count:
            payload.options.count === 0 ? payload.options.count.toString() : "",
          id: payload.options.id
            ? bot.transformers.reverse.snowflake(payload.options.id)
            : "",
