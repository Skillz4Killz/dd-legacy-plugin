...
export function transformAuditLogEntry(
  ...
  const auditLogEntry = {
        ...
        case "id":
          return {
            ...
            old: change.old_value
              ? bot.transformers.snowflake(change.old_value)
              : undefined,
            new: change.new_value
              ? bot.transformers.snowflake(change.new_value)
              : undefined,
          };
        case "name":
        case "description":
    ...
    targetId: payload.target_id
      ? bot.transformers.snowflake(payload.target_id)
      : undefined,
    ...
    options: payload.options
      ? {
          ...
          channelId: payload.options.channel_id
            ? bot.transformers.snowflake(payload.options.channel_id)
            : undefined,
          ...
          id: payload.options.id
            ? bot.transformers.snowflake(payload.options.id)
            : undefined,
